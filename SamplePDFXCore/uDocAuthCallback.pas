...
interface
uses
  System.SysUtils, Winapi.Windows, System.Win.ComObj, PDFXCoreAPI_TLB, Vcl.Graphics, math, matrix;
...
type
  ...
  public
    ...
    constructor Create(inst: TPXC_Inst);
...
constructor TDocAuthCallback.Create(inst: TPXC_Inst);
begin
